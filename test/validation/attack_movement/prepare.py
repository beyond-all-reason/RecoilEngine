...
p.add_argument('--benchmark', action='store_true', help='Disable parity.lua snapshots; retain frame timings')
a = p.parse_args()
...
# Replace, rather than overwrite, the hardlink to preserve the source checkout.
ui = game / 'luaui.lua'
ui.unlink(missing_ok=True)
ui.write_text('-- UI disabled for isolated simulation validation.\n')
