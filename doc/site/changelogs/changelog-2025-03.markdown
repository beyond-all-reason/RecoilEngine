...
recursively stripped of anything that isn't a supported type and has no metatable.
...
* add `Game.buildGridResolution`, number which is currently 2. This means that buildings created via native build orders
