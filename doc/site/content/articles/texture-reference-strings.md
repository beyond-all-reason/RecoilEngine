...
| $info:radar            |                                                                                                          |                                                                                      |
| $info:los:X            | LOS-map overlay tracking allyteam X (a numeric allyTeamID), e.g. "$info:los:2"                           | Restricted to the handle's own allyteam unless spectating or having full read access |
