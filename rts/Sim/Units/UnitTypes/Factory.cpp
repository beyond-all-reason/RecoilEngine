...
void CFactory::KillUnit(CUnit* attacker, bool selfDestruct, bool reclaimed, int weaponDefID, int attackerTeamID)
{
	...
	CUnit::KillUnit(attacker, selfDestruct, reclaimed, weaponDefID, attackerTeamID);
}
