...
if (APPLE AND RECOIL_MACOS_SDL3_EGL)
  ...
  if (SDL3_FOUND AND NOT TARGET SDL2::SDL2)
    add_library(SDL2_SDL3Compat INTERFACE)
    add_library(SDL2::SDL2 ALIAS SDL2_SDL3Compat)
    target_link_libraries(SDL2_SDL3Compat INTERFACE SDL3::SDL3)
    target_include_directories(SDL2_SDL3Compat BEFORE INTERFACE "${CMAKE_SOURCE_DIR}/rts/System/SDLCompat")
    target_compile_definitions(SDL2_SDL3Compat INTERFACE RECOIL_MACOS_SDL3_EGL=1 SDL_ENABLE_OLD_NAMES=1)
  endif()
