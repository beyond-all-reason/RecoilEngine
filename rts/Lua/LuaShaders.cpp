...
int LuaShaders::Uniform(lua_State* L)
{
	...
	switch (numValues) {
	case 1: glUniform1f(location, luaL_checkfloat(L, 2)); break;
	case 2: glUniform2f(location, luaL_checkfloat(L, 2), luaL_checkfloat(L, 3)); break;
	case 3: glUniform3f(location, luaL_checkfloat(L, 2), luaL_checkfloat(L, 3), luaL_checkfloat(L, 4)); break;
	case 4:
		glUniform4f(
...
int LuaShaders::UniformInt(lua_State* L)
{
	...
	switch (numValues) {
	case 1: glUniform1i(location, luaL_checkint(L, 2)); break;
	case 2: glUniform2i(location, luaL_checkint(L, 2), luaL_checkint(L, 3)); break;
	case 3: glUniform3i(location, luaL_checkint(L, 2), luaL_checkint(L, 3), luaL_checkint(L, 4)); break;
	case 4:
		glUniform4i(location, luaL_checkint(L, 2), luaL_checkint(L, 3), luaL_checkint(L, 4), luaL_checkint(L, 5));
		break;
	default: luaL_error(L, "Incorrect arguments to gl.UniformInt()");
	}
